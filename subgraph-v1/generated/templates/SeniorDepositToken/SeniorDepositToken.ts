...
export class SeniorDepositToken__unbondingsResult {
  value0: BigInt;
  value1: BigInt;
...
export class SeniorDepositToken extends ethereum.SmartContract {
  static bind(address: Address): SeniorDepositToken {
    return new SeniorDepositToken("SeniorDepositToken", address);
  }
  ...
  claimable(_user: Address): BigInt {
  ...
  try_claimable(_user: Address): ethereum.CallResult<BigInt> {
  ...
  totalUnbonding(): BigInt {
    let result = super.call("totalUnbonding", "totalUnbonding():(uint256)", []);

    return result[0].toBigInt();
  }

  try_totalUnbonding(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "totalUnbonding",
      "totalUnbonding():(uint256)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  unbondings(param0: Address): SeniorDepositToken__unbondingsResult {
    let result = super.call(
      "unbondings",
    ...
    return new SeniorDepositToken__unbondingsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_unbondings(
    param0: Address
  ): ethereum.CallResult<SeniorDepositToken__unbondingsResult> {
    let result = super.tryCall(
      "unbondings",
      "unbondings(address):(uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new SeniorDepositToken__unbondingsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  withdraw(_asset: BigInt, _receiver: Address, _owner: Address): BigInt {
    let result = super.call(
      "withdraw",
